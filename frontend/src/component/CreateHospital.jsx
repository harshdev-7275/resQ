...
const CreateHospital = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            // Send the formData to the backend API to create the hospital
            const res = await axios.post("http://localhost:4000/api/admin/createHospital", formData);
            console.log(res);
    ...
    return (
        <div className='max-w-[1200px] min-h-[57.7vh] my-10'>
            <div className='container flex items-center flex-col justify-center gap-10 ml-28'>
                <div>
                    <h1 className='text-xl font-semibold'>Create New Hospital</h1>
                </div>
